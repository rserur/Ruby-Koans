...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit:
    # Inject takes your inject(?) argument and uses it as the first iteration of
    # your variable. The result of your manipulation will be used as the variable
    # for the next iteration acting on the next member of the array, ad infinitum
  end
